...
if __name__ == "__main__":
    try:
        with Yaffs2Forensic({
            ...
            #log(args, 0, f"{allObj}")
            if (args.wide):
                log(args, 0, f"\n{'obj.ID':>9}  {'ver.':>6}  {'parentId':>9}  {'name':<50}  {'mode':>10}  {'size':>10}  {'uid':>6}  {'gid':>6}  {'ctime':>19}  {'atime':>19}  {'mtime':>19}  {'sequence':>10}  {'offset':>10}  {'data_offset':>11}   {'sha1sum':<8}")
                for obj in allObj:
                    log(args, 0, f"{obj['object_id']:>9}  {obj['version_num']:>6}  {obj['parent_obj_id']:>9}  {obj['filename']:<50}  {obj['mode']:>10}  {obj['size']:>10}  {obj['uid']:>6}  {obj['gid']:>6}  {obj['ctime']:>19}  {obj['atime']:>19}  {obj['mtime']:>19}  {obj['sequence']:>10}  {hex(obj['offset']):>10}  {hex(obj['data_offset']):>11}   {obj['sha1']}")
            else :
            ...
            if args.outdir:
                ...
                for obj in allObj:
                    ...
                    if args.last_only is not None and args.last_only:
                        max_seq = None
                        offset  = None
                    (assembled, sha1, foo) = yaffs2.get_data({
